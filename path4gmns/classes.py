...
class VDFPeriod:
    ...
    def __init__(self, id, alpha=0.15, beta=4, mu=1000, fftt=0, cap=99999, phf=-1):
        """default constructor"""
        self.id = id
...
class Assignment:
    ...
    def find_shortest_path(self, from_node_id, to_node_id, mode, seq_type="node"):
        ...
        return find_shortest_path(self.network, from_node_id, to_node_id, seq_type)
    ...
    def perform_network_assignment_DTALite(
        self, assignment_mode, iter_num, column_update_num
    ):
...
class UI:
    ...
    def find_shortest_path(self, from_node_id, to_node_id, mode="all", seq_type="node"):
        ...
        return self._base_assignment.find_shortest_path(
            from_node_id, to_node_id, mode, seq_type
        )
